...
INSERT INTO `scores` VALUES ('1A10AX',116,4),('1A10AX',118,1),('1A10AX',118,1),('1A10AX',117,1),('1A10AX',120,6);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `ratemycoursedb`.`scores_AFTER_INSERT` AFTER INSERT ON `scores` FOR EACH ROW
BEGIN
	UPDATE course SET course.score = 
    (
    (new.score_given + (SELECT course.score WHERE course.code = new.course_code) )
    / ( Select count(*) from scores where course_code  = new.course_code)
    )
